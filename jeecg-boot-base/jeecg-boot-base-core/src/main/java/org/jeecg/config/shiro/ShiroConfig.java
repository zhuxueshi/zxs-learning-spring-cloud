...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        filterChainDefinitionMap.put("/hbase/**", "anon"); //zxs 微服务登录模块
        filterChainDefinitionMap.put("/sys/cloud/**", "anon"); //zxs 微服务登录模块
        ...
        //websocket排除
        filterChainDefinitionMap.put("/cloudWebsocket/**", "anon");//系统通知和公告
